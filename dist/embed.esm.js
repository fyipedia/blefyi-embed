/* blefyi-embed v1.0.0 | MIT | https://widget.blefyi.com */
...
(function bootstrap() {
  const config = '{"site":"blefyi","name":"BLEFYI","domain":"blefyi.com","accent":"#0EA5E9","attribute":"data-blefyi","apiBase":"https://blefyi.com/api/v1/","searchPath":"/search/","entitySlug":"chips","entityName":"BLE Chips"}';
...
function makeWidgetElement(widgetType, initFn, domainAttrs) {
  ...
  return class extends HTMLElement {
    ...
    connectedCallback() {
      ...
      this._syncDataAttrs();
      initFn(this, '{"site":"blefyi","name":"BLEFYI","domain":"blefyi.com","accent":"#0EA5E9","attribute":"data-blefyi","apiBase":"https://blefyi.com/api/v1/","searchPath":"/search/","entitySlug":"chips","entityName":"BLE Chips"}');
    }
    ...
    _syncDataAttrs() {
      const attrKey = '{"site":"blefyi","name":"BLEFYI","domain":"blefyi.com","accent":"#0EA5E9","attribute":"data-blefyi","apiBase":"https://blefyi.com/api/v1/","searchPath":"/search/","entitySlug":"chips","entityName":"BLE Chips"}'.attribute.replace("data-", "");
...
(function registerElements() {
  ...
  const site = '{"site":"blefyi","name":"BLEFYI","domain":"blefyi.com","accent":"#0EA5E9","attribute":"data-blefyi","apiBase":"https://blefyi.com/api/v1/","searchPath":"/search/","entitySlug":"chips","entityName":"BLE Chips"}'.site;
  const defs = [
    ...
    [`${site}-frequency`, initFrequencyWidget, ["slug", "channel"]]
  ];
